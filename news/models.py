...
class News(models.Model):
    ...
    title = models.CharField(max_length=69, verbose_name='Наименование')
    ...
    is_published = models.BooleanField(
        default=True, verbose_name='Состояние публикации')
    ...
    def __str__(self):
        """Метод для удобного отображения записи."""
        return self.title

    class Meta:
        verbose_name = 'Новость'
        verbose_name_plural = 'Новости'
        """Отсортировать новости"""
        ordering = ['created_at']
